      ...
      <div className="relative bg-white dark:bg-[#121214] rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm p-6 transition-all duration-300">
          ...
          <div className="bg-white dark:bg-[#18181B] rounded-lg p-3 border border-zinc-200 dark:border-zinc-800 shadow-xs">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-[11px] text-zinc-600 dark:text-zinc-400 mt-1">San Jose, CA • Business profile optimization</p>
              </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          <div className="p-3.5 bg-white dark:bg-[#18181B] rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
            ...
            <p className="text-xl font-bold text-zinc-950 dark:text-white">Performance</p>
            <p className="text-[10px] text-zinc-600 dark:text-zinc-400 font-semibold mt-0.5">Measure with your own field data</p>
          </div>
          ...
          <div className="p-3.5 bg-white dark:bg-[#18181B] rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
            ...
            <p className="text-xl font-bold text-zinc-950 dark:text-white">Lead quality</p>
            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 font-medium mt-0.5">Track with agreed reporting</p>
          </div>
        </div>
