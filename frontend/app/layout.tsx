...
export const metadata: Metadata = {
  title: 'SEO Services San Jose | Local SEO & Digital Marketing | Sanjse SEO Services',
  description: 'Sanjse SEO Services helps San Jose businesses improve search visibility, attract qualified organic traffic, and grow with data-driven SEO strategies, local SEO, and technical optimization.',
  keywords: ['SEO services San Jose', 'local SEO San Jose', 'technical SEO San Jose', 'Google Maps SEO San Jose'],
  openGraph: {
    title: 'SEO Services San Jose | Sanjse SEO Services',
